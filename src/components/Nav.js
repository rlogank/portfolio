...
const Nav = () => {
  ...
  return (
    <nav
      data-aos="fade"
      className="fixed z-[9999] flex h-[56px] w-full items-center border-b bg-white px-2.5 sm:transition-all dark:border-borderDark dark:bg-bgDark"
    >
      <div className="mx-auto flex w-full max-w-screen-lg items-center justify-between">
        <h1
          ...
          data-aos="fade"
          data-aos-delay="100"
          className="heading flex w-2/6 items-center gap-1.5 text-lg font-semibold text-neutral-600 sm:transition-all dark:text-light"
        >
            ...
            return (
              <button>
                <a
                  ...
                  rel="noreferrer"
                  href={s.url}
                  className={`text-neutral-500  ${s.bg} flex h-[56px] items-center gap-1 self-center px-3.5 text-[0.8rem] !sm:transition-all !duration-200 hover:bg-opacity-5 hover:text-black dark:text-light dark:hover:bg-bgDarker sm:px-5`}
                >
                  <div
                    className={clsx(
                      activeItem === s.name && `${s.color} sm:transition-all`,
                      "text-base text-neutral-500 sm:transition-all dark:text-light sm:text-sm"
                    )}
                  >
                    {s.icon}
                  </div>
        ...
        >
          ...
          sm:transition-all gap-1.5 hover:shadow-md active:shadow-none dark:bg-bgDarker dark:text-light  font-medium"
          >
