      ...
      <div className="mx-auto flex max-w-screen-lg flex-col items-center justify-start">
        <div className="flex flex-col items-center gap-10 md:flex-row">
          <div className="">
            ...
            <div
              data-aos="fade"
              className="heading text-center text-4xl font-bold tracking-tight text-rose-500 transition-all dark:text-rose-400 sm:text-center md:text-left md:text-4xl lg:text-5xl"
            >
              contact me
            </div>
            <div
                ...
                <div className="space-y-2.5 text-sm md:space-y-5">
                  <div className="flex gap-2.5 md:gap-5">
                    <input
                      ...
                      required
                      placeholder="Name"
                      className="flex w-1/2 cursor-pointer self-center rounded-[4px] py-2 px-3.5 outline outline-transparent transition-all hover:bg-opacity-20  focus:cursor-text focus:bg-opacity-25 focus:outline-rose-500 dark:bg-bgDark dark:focus:outline-rose-400"
                    />
                    <input
                  ...
                  <textarea
                    ...
                    required
                    placeholder="Message"
                    className="flex w-full cursor-pointer resize-none self-center rounded-[4px] py-2 px-3.5 outline outline-transparent transition-all hover:bg-opacity-20  focus:cursor-text focus:bg-opacity-25 focus:outline-rose-500 dark:bg-bgDark dark:focus:outline-rose-400"
                  />
                </div>
