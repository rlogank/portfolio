            ...
            return (
              <div data-aos="fade">
                <a
                  ...
                  rel="noreferrer"
                  key={i}
                  className="flex min-h-[138px] cursor-pointer select-none flex-col justify-between rounded-[4px] border-t-4 border-rose-500 bg-white bg-opacity-70 shadow-md transition-all hover:scale-105 hover:shadow-lg focus:scale-100 focus:shadow-none active:shadow-none dark:border-bgDark dark:bg-bgDarker dark:bg-opacity-100"
                >
