...
const Services = ({ open, setOpen }) => {
  return (
    <>
      <div className="hidden w-full items-center justify-center rounded-xl text-white lg:flex lg:gap-3.5 lg:text-2xl">
        <a target="_blank" rel="noreferrer" href="https://github.com/rlogank">
          <button className="flex aspect-square w-14 cursor-pointer items-center justify-center self-center rounded-xl outline outline-transparent transition hover:bg-black hover:bg-opacity-10 focus:outline-blue-400 active:bg-opacity-20">
            <SiGithub />
          </button>
        </a>
